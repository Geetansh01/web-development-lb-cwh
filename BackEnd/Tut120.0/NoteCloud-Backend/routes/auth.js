...
// Create user using POST request. No login required
// router.post(
//   "/createuser",
//   [
...
//       return res.status(500).send("Some Error Occurred! It's Internal Server Error");
//     }
//   }
// );

// Login user using POST request. No login required
router.post(
  "/login",
  [
    body("email", "Err msg : Pls enter valid email").isEmail(), //verify valid email format
